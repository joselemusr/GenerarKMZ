    ...
    if isinstance(estructurasTramo, list):
        if isinstance(estructurasTramoLimpias, list):
            ...
            for numeroConjunto in range(len(ConjuntosLimpios)):
                ...
                print(f'route_points: {route_points}')
